...
This makes a `tgz` file of the complete source tree: _crtn_src-0.1.0.tgz_
...
* _crtn_0.1.0_amd64.deb (deb)_
* _crtn-0.1.0-1.x86_64.rpm (rpm)_
* _crtn-0.1.0-Linux-crtn.tar.gz (tgz)_
* _crtn-0.1.0-Linux-crtn.sh (stgz)_
