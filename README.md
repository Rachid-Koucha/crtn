...
To measure the tests coverage, the `gcov/lcov` packages are required. For example, the test coverage with the semaphore/mailbox optional services:
```
$ make clean
...
```
$ ./crtn_install.sh -C firefox -o mbx -o sem
```
